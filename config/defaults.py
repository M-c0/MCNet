...
_C.DATALOADER.NUM_WORKERS = 2 # This may be affected by the order of data reading，you can change it to 8.
...
_C.SOLVER.WEIGHT_DECAY = 0.0001  # 0.0001
_C.SOLVER.WEIGHT_DECAY_BIAS = 0.0001  # 0.0001
